...
namespace Spider.Infrastructure.Logs.Core
{
    ...
    public abstract class LogBase<TContent> : ILog where TContent : class, ILogContent
    {
        ...
        protected virtual void Init(TContent content)
        {
            ...
            content.OperationTime = DateTime.Now.ToString();
            content.Duration = Context.Stopwatch.Elapsed.TotalSeconds.ToString();
        ...
        private void Execute(LogLevel level, ref TContent content)
        {
            ...
            try
            {
                content.Level = System.Enum.GetName(typeof(LogLevel), level);
                Init(content);
