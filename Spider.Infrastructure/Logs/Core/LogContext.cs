...
using Spider.Infrastructure.Contexts;
using Spider.Infrastructure.Logs.Abstractions;
using Spider.Infrastructure.Logs.Internal;

namespace Spider.Infrastructure.Logs.Core {
    /// <summary>
    /// 日志上下文
    /// </summary>
    public class LogContext : ILogContext {
        ...
        private LogContextInfo GetInfo() {
            if ( _info != null )
                return _info;
            var key = "Spider.Infrastructure.Logs.LogContext";
        ...
        protected string GetTraceId() {
            ...
            return string.IsNullOrWhiteSpace( traceId ) ? System.Guid.NewGuid().ToString("N") : traceId;
        }
